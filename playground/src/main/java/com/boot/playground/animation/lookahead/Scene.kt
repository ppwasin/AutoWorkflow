...
class SceneScope
internal constructor(lookaheadLayoutScope: LookaheadLayoutScope) :
  ...
  fun Modifier.sharedElement(): Modifier = composed {
    ...
    var placementOffset: IntOffset by remember {
    ...
    this.onPlaced { lookaheadScopeCoordinates, layoutCoordinates ->
        targetOffset =
      ...
      .intermediateLayout { measurable, _, lookaheadSize ->
        ...
        layout(placeable.width, placeable.height) {
          val (x, y) =
            offsetAnimation?.run { value - placementOffset }
